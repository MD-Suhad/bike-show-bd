...
const MyOrder = (props) => {
  ...
  const { title, image, _id, id } = props.data.purchasedCar[0];
  ...
  const handleRemove = (id) => {
    ...
    if (proceed) {
      const url = `https://pure-stream-69695.herokuapp.com/placeOrders/${id}`;
      ...
      <Col>
        ...
        >
          ...
          />
            ...
            <Button onClick={() => handleRemove(parseInt(id))}>Remove</Button>
          </Card.Body>
        </Card>
      </Col>
    </>
